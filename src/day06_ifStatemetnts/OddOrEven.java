...
public class OddOrEven {
    ...
    public static void main(String[] args) {
        ...
        int numberr = 30;
        boolean isEvenn = numberr % 2 == 0; // when we divide a number by 2, if the remainder is 0, means the number is even
        boolean isOddd =!isEvenn;
        System.out.println(numberr+" is an even number: "+isEvenn);
        System.out.println(numberr+" is an even number: "+isOddd);
        System.out.println("--------------------------------------------");
