...
Warmup Tasks:
    1. Create a class named LoanApplication. two variables named salary and createdScore
     are declared and given, write a program that can check if the person is eligible to apply for a loan
            Note:In order to be eligible for a loan:
                    1. salary: at least 45K
                    2. credit score: at least 700


	2. Create a class named Grade, a char variable named grade is given. write a program
    ...
    3. Create a class named NetIncomeCalc, Write a program that can calculate the salary
...
If & Else: when there are TWO (not more, not less than 2) options/possibilities/alternatives
 we need to create condition for

            for 2 conditions


Multi branch If: when there are three more options/possibilities/alternatives we need to create
 condition for
...
If statement without curly braces:
            without the curly braces the blocks of if statement can only have one statement in
            its body
