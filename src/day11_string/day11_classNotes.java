...
Warmup tasks:
	1. Create a class named LongestString
			...
			1.2 Write a program that can print the longest string, if both have the same number of
			 characters then print "Equal"
	...
	3. Create a class named DigitLetterSpecialChar and wirte a program that can ask the user to enter
	a word
...
String Methods:
	...
	replace(oldValue, newValue): returns new string by repalcing All the old values with the
	given new value.


	replaceFirst(oldValue, newValue): returns new string by repalcing  the FIRST matchingold
	values with the given new value.


	substring(beginningIndex , endingIndex): creates substring starting from the given beginning
	index till the given edning index (ending index is excluded)

					String str ="Cydeo School";
				   str.substring(0,  4+1) ==> Cydeo


	substring(beginningIndex): creates substring starting from the given beginning index till
