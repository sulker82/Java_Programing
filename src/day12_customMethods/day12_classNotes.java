...
public class day12_classNotes {
    /*
    Java Programming Day12

Topic: Custom methods Intro
				Void Methods
				Parameters

package name: day12_customMethods

Warmup tasks:
	1. Write a program that asks user to enter first and last names, and then prints the full
	name in regular format (first character in upper case)
